...
const client = configured
  ? new S3Client({
      ...
      // Without this, a hung R2 connection could stall an upload/download
      // request indefinitely — the AWS SDK v3 default has no meaningful
      // socket timeout on its own.
