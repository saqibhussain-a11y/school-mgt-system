import { LayoutDashboard, Building2, ScrollText, BarChart3, Activity, Tags } from "lucide-react";
import type { NavItem } from "./nav-config";

// Flat — six items still doesn't need the expand/collapse machinery the
// tenant sidebar's Academics/Exams sections needed, and there's no per-role
